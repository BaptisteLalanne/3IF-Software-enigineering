...
Mesure::Mesure(const string &laDate, string idMesure, double concentrationOzone, double concentrationDioxydeSoufre,
               double concentartionDioxydeAzote, double concentrationPM) {
    dateMesure = laDate;
    id = idMesure;
